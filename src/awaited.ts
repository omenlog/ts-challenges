...
type Thenable<T> = Promise<T | Thenable<T>> | { then: (onfulfilled: (arg: T) => unknown) => unknown}

type MyAwaited<T extends Thenable<unknown>> = T extends Thenable<infer E> ? E : never;
